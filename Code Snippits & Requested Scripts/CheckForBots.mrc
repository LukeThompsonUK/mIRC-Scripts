...
raw 352:*B*:{
  ...
  if (%Bots = 2) { 
    part %ChanCheck Sorry, I have found 2 people marked with usermode B in this channel. If they are not bots have them remove the bot usermode and invite me again. 
  }
}
